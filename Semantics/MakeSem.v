...
Module Type SEM.
 ...
 Declare Module E : EXPR UT T Var Mem Uop O.

 Declare Module US : USUPPORT UT T Var Mem Uop O E.

 Declare Module DE : DEXPR UT T Var Mem Uop O E US.

 Declare Module I : INSTR UT T Var Proc Uop O Mem E US DE.

 Declare Module SemI : SEM_INSTR UT T Var Proc Uop O Mem E US DE I.
...
Module Make (UT_:UTYPE) (T_:TYPE UT_) (Uop_:UOP UT_ T_) 
 (US_:USUPPORT UT_ T_) <: SEM.
 ...
 Module E := MakeExpr UT_ T_ Var Mem Uop O.

 Module US := US_ Var Mem Uop O E.

 Module DE := MakeDExpr UT_ T_ Var Mem Uop O E US.

 Module I := MakeInstr UT_ T_ Var Proc Uop O Mem E US DE.

 Module SemI := SemInstr.Make UT T_ Var Proc Uop O Mem E US DE I.
